        ...
        <div className="rounded-2xl bg-white p-8 shadow-sm">
                ...
                <div className="flex w-full items-center justify-between gap-5 pl-5">
                  ...
                  >
                    ...
                    <img
                      ...
                      className="my-auto aspect-[1] w-[25] shrink-0 self-stretch object-contain"
                      alt="Upgrade icon"
                    />
                  </Button>
                </div>
                ...
                <div className="flex w-full flex-col items-stretch justify-center pl-5 font-normal">
                  ...
                  <div className="mt-2">
                    <Input
                      ...
                      className={`rounded-[7] border-solid border-gray-300 ${errors.password ? "border-red-500" : ""}`}
                      placeholder="**************"
                    />
          ...
          <div className="mt-8 flex justify-end gap-4">
            ...
            <Button
              ...
              disabled={!isFormModified}
              className="-6 bg-[rgba(25,53,202,1)] hover:bg-[rgba(20,43,170,1)]"
            >
