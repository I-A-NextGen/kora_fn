...
const StartExamCard = () => {
  return (
    <div className="relative flex h-60 w-full flex-row items-end gap-4 rounded-2xl bg-primary p-6 text-white shadow-xl md:h-60 md:shadow-xl">
      ...
      <div className="flex flex-col gap-3">
        ...
        <GetStarted
          triggerIcon={false}
          triggerStyle="h-fit mt-2 w-fit rounded-xl bg-white px-4 py-2 !text-sm font-medium text-primary hover:bg-gray-200"
          readyToStartProp
        />
      </div>
      <Image
